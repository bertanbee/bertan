...
export default function Curriculum () {
    ...
    return (
        <CurriculumBox>
            <Header></Header>
            <Curriculo>
                <InfoCardLeft ano="2024" mes="JANEIRO" premio="Qualify - Instituto de Formação de Líderes Jovem" complemento="Local:" quem="IFLJovem" link1="LINK" link1href="https://www.ifljovemsp.org/"></InfoCardLeft>
