                ...
                <div style={{ width: "30%", height: "500px", display: "flex", flexDirection: "column" }}>
                    ...
                    <SelectionTextDiv style={{ marginTop: "-450px", textAlign: "center" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "row", width: "100%", textAlign: "center" }}>
                            <div style={{ display: "flex", flexDirection: "row", width: "100%", textAlign: "center" }}>
                                <Link style={{textDecoration: "none"}} to="/curriculo"><SelectionText1 style={{ marginTop: "51px", marginLeft: "-30px", cursor: "default" }}>ACADÊMICO</SelectionText1></Link>
                                <Link style={{textDecoration: "none"}} to="/curriculo"><SelectionText1 style={{ marginTop: "27px", marginLeft: "0px", cursor: "default" }}>PRÊMIOS</SelectionText1></Link>
                            </div>
                            <div style={{ display: "flex", flexDirection: "row", width: "100%", textAlign: "center" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "row", width: "100%", textAlign: "center" }}>
                            <Link style={{textDecoration: "none"}} to="/curriculo"><SelectionText1 style={{ marginTop: "33px", marginLeft: "57px", cursor: "default" }}>CURRÍCULO</SelectionText1></Link>
